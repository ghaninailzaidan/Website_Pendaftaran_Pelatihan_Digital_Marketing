...
<div class="container">
	<div class="row">
		<div class="col">
			<div class="info">
				<center>
					<h2><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Pendaftaran Pelatihan "Digital Marketing"</h2>
				</center>
				...
				<div class="registry">
					...
					<div class="button-class">
						<button type="submit" name="save" class="button btn btn-primary">
							<i class="fas fa-check"></i>&nbsp;&nbsp;Daftar Pelatihan
						</button>

						<button onclick="window.location.href='<?= base_url('registry'); ?>'" type="button" name="cancel" class="button btn btn-danger">
