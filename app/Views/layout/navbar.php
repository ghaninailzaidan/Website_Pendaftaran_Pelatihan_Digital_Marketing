		...
		<ul class="navbar-nav">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<?php else : ?>
						<a class="dropdown-item" href="<?= base_url('registry') ?>"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Registrasi</a>
						<a class="dropdown-item" href="<?= base_url('semnas') ?>"><i class="fas fa-th-list"></i>&nbsp;&nbsp;Peserta</a>
